...
```json
{
  "body": "...markdown body, rendered from the digest template, with [1]..[5] citations whose indices match referenceIds order. Include a single take-away line in this shape, placed wherever it fits naturally:\n\n\"If only one thing sticks: [single sentence the reader can hold onto, grounded in the papers] [2].\"...",
